...
{
    [ApiController]
    [Route("solicitacao-consulta")]

    public class SolicitacaoConsultaController : ControllerBase
    {
        Config Config { get; }
        IMediator Mediator { get; }

        public SolicitacaoConsultaController(IMediator mediator, IOptions<Config> optionsConfig)
        {
            Mediator = mediator;
        ...
        public async Task<object> FuncionalidadeValidar(CancellationToken cancellationToken)
        {
            ...
            return await Mediator.Send(new Application.QueryRequest
            {
                ...
                Endpoint = $"{Config.ApiHost}/solicitacao-consulta/funcionalidade-validar{Request.QueryString}",
            },
            cancellationToken);
        }
        ...
        public async Task<object> ConsultaSituacaoCarregar(CancellationToken cancellationToken)
        {
            ...
            {
                Meta = Request.Headers.ToRequestMeta(),
                Endpoint = $"{Config.ApiHost}/solicitacao-consulta/consulta-situacao-carregar{Request.QueryString}",
            },
                       cancellationToken);
        }
        ...
        public async Task<object> ConsultaListar(CancellationToken cancellationToken)
        {
            ...
            {
                Meta = Request.Headers.ToRequestMeta(),
                Endpoint = $"{Config.ApiHost}/solicitacao-consulta/consulta-listar{Request.QueryString}",
            },
            cancellationToken);
        }
        ...
        public IAsyncEnumerable<object> ConsultaExportar(CancellationToken cancellationToken)
        {
            ...
            {
                Meta = Request.Headers.ToRequestMeta(),
                Endpoint = $"{Config.ApiHost}/solicitacao-consulta/consulta-exportar{Request.QueryString}",
            },
            cancellationToken);
        }
        ...
        public async Task<object> ConsultaImprimir(CancellationToken cancellationToken)
        {
            ...
            {
                Meta = Request.Headers.ToRequestMeta(),
                Endpoint = $"{Config.ApiHost}/solicitacao-consulta/consulta-imprimir{Request.QueryString}",
            },
                       cancellationToken);
        }
